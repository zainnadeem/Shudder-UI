...
class NavBarView: UIView {
    ...
    func createToolBar(_ left : UIImage?, right : UIImage?, middle : UIImage?){
        self.topToolBar.backgroundColor = shudderBackgroundColor
        ...
        middleButton.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 20)], for: .normal)
    ...
    @objc func rightBarButtonTapped(_ sender: AnyObject) {
    ...
    @objc func leftBarButtonTapped(_ sender: AnyObject) {
    ...
    @objc func middleBarButtonTapped(_ sender: AnyObject) {
